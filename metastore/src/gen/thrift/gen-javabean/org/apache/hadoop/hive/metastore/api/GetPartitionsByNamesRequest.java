            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.names = new ArrayList<String>(_list244.size);
                String _elem245;
                for (int _i246 = 0; _i246 < _list244.size; ++_i246)
                {
                  _elem245 = iprot.readString();
                  struct.names.add(_elem245);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.names != null) {
        if (struct.isSetNames()) {
          oprot.writeFieldBegin(NAMES_FIELD_DESC);
          {
            ...
            for (String _iter247 : struct.names)
            {
      ...
      if (struct.isSetNames()) {
        {
          ...
          for (String _iter248 : struct.names)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.names = new ArrayList<String>(_list249.size);
          String _elem250;
          for (int _i251 = 0; _i251 < _list249.size; ++_i251)
          {
            _elem250 = iprot.readString();
            struct.names.add(_elem250);
          }
        }
        struct.setNamesIsSet(true);
      }
