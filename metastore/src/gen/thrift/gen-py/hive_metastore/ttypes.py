...
class Table:
  ...
  thrift_spec = (
    ...
    (15, TType.STRUCT, 'colStats', (ColumnStatistics, ColumnStatistics.thrift_spec), None, ), # 15
  )

  def __init__(self, tableName=None, dbName=None, owner=None, createTime=None, lastAccessTime=None, retention=None, sd=None, partitionKeys=None, parameters=None, viewOriginalText=None, viewExpandedText=None, tableType=None, privileges=None, temporary=thrift_spec[14][4], colStats=None,):
  ...
  def write(self, oprot):
    ...
    if self.colStats is not None:
      oprot.writeFieldBegin('colStats', TType.STRUCT, 15)
...
class Partition:
  ...
  thrift_spec = (
    ...
    (9, TType.STRUCT, 'colStats', (ColumnStatistics, ColumnStatistics.thrift_spec), None, ), # 9
  )

  def __init__(self, values=None, dbName=None, tableName=None, createTime=None, lastAccessTime=None, sd=None, parameters=None, privileges=None, colStats=None,):
    self.values = values
    self.dbName = dbName
    self.tableName = tableName
    self.createTime = createTime
  ...
  def write(self, oprot):
    ...
    if self.privileges is not None:
      ...
      oprot.writeFieldEnd()
    if self.colStats is not None:
      oprot.writeFieldBegin('colStats', TType.STRUCT, 9)
      self.colStats.write(oprot)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i257 in xrange(_size253):
            _elem258 = ColumnStatisticsObj()
            _elem258.read(iprot)
            self.statsObj.append(_elem258)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i264 in xrange(_size260):
            _elem265 = ColumnStatisticsObj()
            _elem265.read(iprot)
            self.colStats.append(_elem265)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i271 in xrange(_size267):
            _elem272 = ColumnStatistics()
            _elem272.read(iprot)
            self.colStats.append(_elem272)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class Schema:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i278 in xrange(_size274):
            ...
            _elem279.read(iprot)
            self.fieldSchemas.append(_elem279)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.MAP:
          ...
          for _i284 in xrange(_size280):
            ...
            self.properties[_key285] = _val286
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.fieldSchemas is not None:
      ...
      for iter287 in self.fieldSchemas:
        iter287.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
...
class EnvironmentContext:
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i294 in xrange(_size290):
            ...
            self.properties[_key295] = _val296
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.properties is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.properties))
      for kiter297,viter298 in self.properties.items():
...
class CompactionRequest:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i452 in xrange(_size448):
            ...
            self.properties[_key453] = _val454
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.properties is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.properties))
      for kiter455,viter456 in self.properties.items():
        oprot.writeString(kiter455)
        oprot.writeString(viter456)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i461 in xrange(_size457):
            _elem462 = ShowCompactResponseElement()
            _elem462.read(iprot)
            self.compacts.append(_elem462)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class AddDynamicPartitions:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i468 in xrange(_size464):
            ...
            self.partitionnames.append(_elem469)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 5:
  ...
  def write(self, oprot):
    ...
    if self.partitionnames is not None:
      ...
      for iter470 in self.partitionnames:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i475 in xrange(_size471):
            _elem476 = NotificationEvent()
            _elem476.read(iprot)
            self.events.append(_elem476)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class InsertEventRequestData:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i482 in xrange(_size478):
            ...
            self.filesAdded.append(_elem483)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.LIST:
          ...
          for _i488 in xrange(_size484):
            ...
            self.filesAddedChecksum.append(_elem489)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.filesAdded is not None:
      ...
      for iter490 in self.filesAdded:
    ...
    if self.filesAddedChecksum is not None:
      ...
      for iter491 in self.filesAddedChecksum:
...
class FireEventRequest:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i496 in xrange(_size492):
            ...
            self.partitionVals.append(_elem497)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.partitionVals is not None:
      ...
      for iter498 in self.partitionVals:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i503 in xrange(_size499):
            _elem504 = Function()
            _elem504.read(iprot)
            self.functions.append(_elem504)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
