      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i547 in xrange(_size543):
            ...
            self.tbl_names.append(_elem548)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i568 in xrange(_size564):
            _elem569 = Partition()
            _elem569.read(iprot)
            self.new_parts.append(_elem569)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class get_partition_with_auth_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i632 in xrange(_size628):
            ...
            self.group_names.append(_elem633)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.group_names is not None:
      ...
      for iter635 in self.group_names:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i647 in xrange(_size643):
            ...
            self.group_names.append(_elem648)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class get_partitions_ps_with_auth_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i695 in xrange(_size691):
            ...
            self.group_names.append(_elem696)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.group_names is not None:
      ...
      oprot.writeListBegin(TType.STRING, len(self.group_names))
      for iter698 in self.group_names:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i752 in xrange(_size748):
            _elem753 = Partition()
            _elem753.read(iprot)
            self.new_parts.append(_elem753)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i759 in xrange(_size755):
            ...
            self.part_vals.append(_elem760)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
...
class partition_name_to_spec_result:
  ...
  def write(self, oprot):
    ...
    if self.success is not None:
      ...
      for kiter783,viter784 in self.success.items():
...
class isPartitionMarkedForEvent_args:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          self.part_vals = {}
          (_ktype795, _vtype796, _size794 ) = iprot.readMapBegin()
          for _i798 in xrange(_size794):
            _key799 = iprot.readString()
            _val800 = iprot.readString()
            self.part_vals[_key799] = _val800
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.part_vals is not None:
      oprot.writeFieldBegin('part_vals', TType.MAP, 3)
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.part_vals))
      for kiter801,viter802 in self.part_vals.items():
        oprot.writeString(kiter801)
        oprot.writeString(viter802)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.eventType is not None:
      oprot.writeFieldBegin('eventType', TType.I32, 4)
