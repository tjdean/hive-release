      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i540 in xrange(_size536):
            ...
            self.partNames.append(_elem541)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i561 in xrange(_size557):
            ...
            self.tbl_names.append(_elem562)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class exchange_partition_args:
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i631 in xrange(_size627):
            ...
            self.partitionSpecs[_key632] = _val633
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.partitionSpecs is not None:
      ...
      for kiter634,viter635 in self.partitionSpecs.items():
