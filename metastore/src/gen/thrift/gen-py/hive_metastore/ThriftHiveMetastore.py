      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i547 in xrange(_size543):
            ...
            self.partNames.append(_elem548)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i568 in xrange(_size564):
            ...
            self.tbl_names.append(_elem569)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i589 in xrange(_size585):
            _elem590 = Partition()
            _elem590.read(iprot)
            self.new_parts.append(_elem590)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i596 in xrange(_size592):
            _elem597 = PartitionSpec()
            _elem597.read(iprot)
            self.new_parts.append(_elem597)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class exchange_partition_args:
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i638 in xrange(_size634):
            ...
            self.partitionSpecs[_key639] = _val640
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.partitionSpecs is not None:
      ...
      for kiter641,viter642 in self.partitionSpecs.items():
        oprot.writeString(kiter641)
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i653 in xrange(_size649):
            ...
            self.group_names.append(_elem654)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class get_partitions_with_auth_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i668 in xrange(_size664):
            ...
            self.group_names.append(_elem669)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.group_names is not None:
      oprot.writeFieldBegin('group_names', TType.LIST, 5)
      oprot.writeListBegin(TType.STRING, len(self.group_names))
      for iter670 in self.group_names:
...
class get_partitions_ps_with_auth_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i716 in xrange(_size712):
            ...
            self.group_names.append(_elem717)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.group_names is not None:
      ...
      oprot.writeListBegin(TType.STRING, len(self.group_names))
      for iter719 in self.group_names:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i731 in xrange(_size727):
            ...
            self.part_vals.append(_elem732)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i780 in xrange(_size776):
            _elem781 = Partition()
            _elem781.read(iprot)
            self.new_parts.append(_elem781)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i794 in xrange(_size790):
            ...
            self.part_vals.append(_elem795)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.success is not None:
      ...
      for kiter811,viter812 in self.success.items():
        oprot.writeString(kiter811)
        oprot.writeString(viter812)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.o1 is not None:
      oprot.writeFieldBegin('o1', TType.STRUCT, 1)
...
class markPartitionForEvent_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i817 in xrange(_size813):
            ...
            self.part_vals[_key818] = _val819
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.part_vals is not None:
      ...
      for kiter820,viter821 in self.part_vals.items():
...
class isPartitionMarkedForEvent_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i826 in xrange(_size822):
            ...
            self.part_vals[_key827] = _val828
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.part_vals is not None:
      oprot.writeFieldBegin('part_vals', TType.MAP, 3)
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.part_vals))
      for kiter829,viter830 in self.part_vals.items():
...
class set_ugi_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i884 in xrange(_size880):
            ...
            self.group_names.append(_elem885)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.group_names is not None:
      ...
      oprot.writeListBegin(TType.STRING, len(self.group_names))
      for iter886 in self.group_names:
