...
class Table {
  ...
  public function write($output) {
    ...
    if ($this->colStats !== null) {
      ...
      $xfer += $output->writeFieldBegin('colStats', TType::STRUCT, 15);
...
class Partition {
  ...
  public function write($output) {
    ...
    if ($this->colStats !== null) {
      ...
      $xfer += $output->writeFieldBegin('colStats', TType::STRUCT, 9);
      $xfer += $this->colStats->write($output);
      $xfer += $output->writeFieldEnd();
    }
    $xfer += $output->writeFieldStop();
  ...
  public function write($output) {
    ...
    if ($this->parameters !== null) {
      ...
      $xfer += $output->writeFieldBegin('parameters', TType::MAP, 9);
      {
        $output->writeMapBegin(TType::STRING, TType::STRING, count($this->parameters));
        {
          foreach ($this->parameters as $kiter251 => $viter252)
          {
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem258 = null;
              $elem258 = new \metastore\ColumnStatisticsObj();
              $xfer += $elem258->read($input);
              $this->statsObj []= $elem258;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->statsObj !== null) {
      ...
      $xfer += $output->writeFieldBegin('statsObj', TType::LST, 2);
      {
        ...
        {
          foreach ($this->statsObj as $iter259)
          {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem265 = null;
              $elem265 = new \metastore\ColumnStatisticsObj();
              $xfer += $elem265->read($input);
              $this->colStats []= $elem265;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->colStats !== null) {
      ...
      $xfer += $output->writeFieldBegin('colStats', TType::LST, 1);
      {
        ...
        {
          foreach ($this->colStats as $iter266)
          {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem272 = null;
              $elem272 = new \metastore\ColumnStatistics();
              $xfer += $elem272->read($input);
              $this->colStats []= $elem272;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->colStats !== null) {
      ...
      $xfer += $output->writeFieldBegin('colStats', TType::LST, 1);
      {
        $output->writeListBegin(TType::STRUCT, count($this->colStats));
        {
          foreach ($this->colStats as $iter273)
          {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem279 = null;
              $elem279 = new \metastore\FieldSchema();
              $xfer += $elem279->read($input);
              $this->fieldSchemas []= $elem279;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->fieldSchemas !== null) {
      ...
      $xfer += $output->writeFieldBegin('fieldSchemas', TType::LST, 1);
      {
        ...
        {
          foreach ($this->fieldSchemas as $iter287)
          {
  ...
  public function write($output) {
    ...
    if ($this->properties !== null) {
      ...
      $xfer += $output->writeFieldBegin('properties', TType::MAP, 6);
      {
        $output->writeMapBegin(TType::STRING, TType::STRING, count($this->properties));
        {
          foreach ($this->properties as $kiter458 => $viter459)
          {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem465 = null;
              $elem465 = new \metastore\ShowCompactResponseElement();
              $xfer += $elem465->read($input);
              $this->compacts []= $elem465;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->compacts !== null) {
      ...
      $xfer += $output->writeFieldBegin('compacts', TType::LST, 1);
      {
        ...
        {
          foreach ($this->compacts as $iter466)
          {
  ...
  public function write($output) {
    ...
    if ($this->partitionnames !== null) {
      ...
      $xfer += $output->writeFieldBegin('partitionnames', TType::LST, 4);
      {
        ...
        {
          foreach ($this->partitionnames as $iter473)
          {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem479 = null;
              $elem479 = new \metastore\NotificationEvent();
  ...
  public function write($output) {
    ...
    if ($this->events !== null) {
      ...
      $xfer += $output->writeFieldBegin('events', TType::LST, 1);
      {
        ...
        {
          foreach ($this->events as $iter480)
          {
        ...
        case 3:
          if ($ftype == TType::LST) {
            ...
            for ($_i491 = 0; $_i491 < $_size487; ++$_i491)
            {
              ...
              $this->filesAddedChecksum []= $elem492;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->filesAdded !== null) {
      ...
      $xfer += $output->writeFieldBegin('filesAdded', TType::LST, 2);
      {
        ...
        {
          foreach ($this->filesAdded as $iter493)
          {
    ...
    if ($this->filesAddedChecksum !== null) {
      ...
      $xfer += $output->writeFieldBegin('filesAddedChecksum', TType::LST, 3);
      {
        ...
        {
          foreach ($this->filesAddedChecksum as $iter494)
          {
  ...
  public function write($output) {
    ...
    if ($this->partitionVals !== null) {
      ...
      $xfer += $output->writeFieldBegin('partitionVals', TType::LST, 5);
      {
        ...
        {
          foreach ($this->partitionVals as $iter501)
          {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem507 = null;
              $elem507 = new \metastore\Function();
              $xfer += $elem507->read($input);
              $this->functions []= $elem507;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->functions !== null) {
      ...
      $xfer += $output->writeFieldBegin('functions', TType::LST, 1);
      {
        ...
        {
          foreach ($this->functions as $iter508)
          {
