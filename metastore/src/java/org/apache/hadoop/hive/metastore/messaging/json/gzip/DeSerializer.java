...
public class DeSerializer extends JSONMessageDeserializer {
  ...
  public CreateIndexMessage getCreateIndexMessage(String messageBody) {
    return super.getCreateIndexMessage(deCompress(messageBody));
  }

  @Override
  public DropIndexMessage getDropIndexMessage(String messageBody) {
    return super.getDropIndexMessage(deCompress(messageBody));
  }

  @Override
  public AlterIndexMessage getAlterIndexMessage(String messageBody) {
    return super.getAlterIndexMessage(deCompress(messageBody));
  }
