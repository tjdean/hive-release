...
>>>>>>> e3ca81e... HIVE-13302 : direct SQL: cast to date doesn't work on Oracle (Sergey Shelukhin, reviewed by Sushanth Sowmyan)
    if (sqlFilter == null) {
...
>>>>>>> e3ca81e... HIVE-13302 : direct SQL: cast to date doesn't work on Oracle (Sergey Shelukhin, reviewed by Sushanth Sowmyan)
  ...
  private static class PartitionFilterGenerator extends TreeVisitor {
    ...
    private static String generateSqlFilter(Table table, ExpressionTree tree, List<Object> params,
        List<String> joins, boolean dbHasJoinCastBug, DB dbType)
