 ...
 * of fetching all the partitions in one shot is prohibitive.
 *
 ...
 * objects.
 *
 * Note that remove() on the iterator is an illegal call on this, and will
...
public class PartitionIterable implements Iterable<Partition> {
   ...
   */
  public PartitionIterable(Hive db, Table table, @Nullable Map<String, String> partialPartitionSpec, int batch_size) throws HiveException {
