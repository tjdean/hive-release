...
public final class SynchronizedMetaStoreClient {
	...
	public synchronized void heartbeat(long txnid, long lockid)
			throws TException {
		client.heartbeat(txnid, lockid);
	}

	public synchronized ValidTxnList getValidTxns(long currentTxn)
			throws TException {
		return client.getValidTxns(currentTxn);
	}

	public synchronized LockResponse lock(LockRequest request)
			throws TException {
		return client.lock(request);
	}

	public synchronized Partition add_partition(Partition partition)
			throws TException {
	...
	public synchronized ShowLocksResponse showLocks(
			ShowLocksRequest showLocksRequest) throws TException {
	...
	public synchronized org.apache.hadoop.hive.metastore.api.Partition getPartitionWithAuthInfo(
			String dbName, String tableName, List<String> pvals,
			String userName, List<String> groupNames) throws MetaException, UnknownTableException, NoSuchObjectException, TException {
