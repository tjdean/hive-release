...
-- partitioned table
create table orc_split_elim_part (userid bigint, string1 string, subtype double, decimal1 decimal(38,10), ts timestamp) partitioned by (country string, year int) stored as orc;
