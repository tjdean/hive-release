...
create table orc_staging (userid bigint, string1 string, subtype double, decimal1 decimal(38,10), ts timestamp);
create table orc_test (userid bigint, string1 string, subtype double, decimal1 decimal(38,10), ts timestamp) partitioned by (ds string);
