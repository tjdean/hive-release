...
desc formatted v;
select * from v order by key,`_c1` limit 5;
...
desc formatted v;
select * from v order by key, value, `_c2` limit 5;

drop view v;
create view v as select *, '12' as `_c121` from src;
desc formatted v;
select * from v order by key, value, `_c121` limit 5;
...
desc formatted v;
select * from v order by ca, caa, `_c3` limit 5;
