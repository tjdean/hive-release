...
select * from alter_partition_change_col1 where p1='abc' order by c1, c2;
select * from alter_partition_change_col1 where p1='__HIVE_DEFAULT_PARTITION__' order by c1, c2;
...
describe alter_partition_change_col1;
describe alter_partition_change_col1 partition (p1='abc', p2='123');
select * from alter_partition_change_col1 where p1='abc' order by c1;
select * from alter_partition_change_col1 where p1='__HIVE_DEFAULT_PARTITION__' order by c1;
