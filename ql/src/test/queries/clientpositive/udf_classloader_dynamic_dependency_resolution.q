ADD JAR ivy://org.apache.hive.hive-it-custom-udfs:udf-classloader-udf1:${system:hive.version};
ADD JAR ivy://org.apache.hive.hive-it-custom-udfs:udf-classloader-util:${system:hive.version};
ADD JAR ivy://org.apache.hive.hive-it-custom-udfs:udf-classloader-udf2:${system:hive.version};
