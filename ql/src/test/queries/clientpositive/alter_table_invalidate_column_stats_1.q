...
insert overwrite table statsdb1.testtable1 select key, value, 'val3' from src limit 10;

create table statsdb1.testpart1 (col1 int, col2 string, col3 string) partitioned by (part string);
insert overwrite table statsdb1.testpart1 partition (part = 'part1') select key, value, 'val3' from src limit 10;
insert overwrite table statsdb1.testpart1 partition (part = 'part2') select key, value, 'val3' from src limit 20;
