...
public class TestInputOutputFormat {
  ...
  public void testSplitStrategySelection() throws Exception {
    ...
    conf.setLong(HiveConf.ConfVars.HIVE_ORC_CACHE_STRIPE_DETAILS_MEMORY_SIZE.varname,
            100);
  ...
  public void testCombinationInputFormatWithAcid() throws Exception {
    ...
    assertEquals("mock:/combinationAcid/p=0/base_0000010/bucket_00001",
        split.getPath().toString());
    assertEquals(0, split.getStart());
    assertEquals(653, split.getLength());
  ...
  public void testDoAs() throws Exception {
    ...
    try {
      ...
      try {
        ugi.doAs(new PrivilegedExceptionAction<Void>() {
          ...
          public Void run() throws Exception {
            OrcInputFormat.generateSplitsInfo(conf);
            return null;
          }
        });
        fail("Didn't throw");
      ...
      List<OrcSplit> splits = OrcInputFormat.generateSplitsInfo(conf);
  ...
  public void testSplitGenReadOpsLocalCache() throws Exception {
    ...
    conf.setLong(ConfVars.HIVE_ORC_CACHE_STRIPE_DETAILS_MEMORY_SIZE.varname, 10 * 1024 * 1024);
