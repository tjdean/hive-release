...
public class TestReplicationScenariosAcrossInstances {
  ...
  public void testCreateFunctionWithFunctionBinaryJarsOnHDFS() throws Throwable {
    ...
    List<String> jars =
        Lists.transform(Arrays.asList(fileStatuses), new Function<FileStatus, String>() {
          @Nullable
          @Override
  ...
  static class Dependencies {
    ...
    private String toJarSubSql() {
      List<String> result = Lists.transform(fullQualifiedJarPaths, new Function<Path, String>() {
        @Override
