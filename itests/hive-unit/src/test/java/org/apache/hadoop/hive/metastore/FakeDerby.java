...
public class FakeDerby extends org.apache.derby.jdbc.EmbeddedDriver {
  ...
  static {
    org.apache.derby.jdbc.EmbeddedDriver embeddedDriver = new org.apache.derby.jdbc.EmbeddedDriver();
    FakeDerby fakeDerby = new FakeDerby();
    try {
      DriverManager.registerDriver(fakeDerby);
    } catch (SQLException sqle){
      throw new RuntimeException(sqle); // Nothing much else we can do here.
    }
  }
