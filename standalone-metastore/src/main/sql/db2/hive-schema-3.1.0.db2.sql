...
CREATE TABLE SCHEMA_VERSION(SCHEMA_VERSION_ID BIGINT NOT NULL,CD_ID BIGINT,CREATED_AT BIGINT NOT NULL,DESCRIPTION VARCHAR(4000),FINGERPRINT VARCHAR(256),SCHEMA_ID BIGINT NOT NULL,SCHEMA_VERSION_NAME VARCHAR(256),SCHEMA_TEXT CLOB,SERDE_ID BIGINT,"STATE" INTEGER NOT NULL,VERSION INTEGER NOT NULL);
...
CREATE TABLE NOTIFICATION_LOG(NL_ID BIGINT NOT NULL,CAT_NAME VARCHAR(256),DB_NAME VARCHAR(128),EVENT_ID BIGINT NOT NULL,EVENT_TIME INTEGER NOT NULL,EVENT_TYPE VARCHAR(32) NOT NULL,MESSAGE CLOB,MESSAGE_FORMAT VARCHAR(16),TBL_NAME VARCHAR(256));
